...
function handleDelete(instUuid: string) {
  ...
  dialog.warning({
    ...
    content: t('workflow.deleteConfirm'),
...
<template>
  ...
  <NModal v-model:show="showDetailModal" :title="t('common.executionDetail')" style="width: 90%; max-width: 900px;" preset="card">
